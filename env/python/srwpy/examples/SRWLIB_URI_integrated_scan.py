...
def CalcRadiationSpectrum():
    ...
    return ar_Intensity, elecBeam

ar_Intensity, elecBeam = CalcRadiationSpectrum()
...
def ParticleTracking():
    ...
    return partTrajLst, ctMeshLst, arX, arY, arBy, arBz

partTrajLst, ctMeshLst, arX, arY, arBy, arBz = ParticleTracking()
